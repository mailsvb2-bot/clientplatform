...
class NativeMessengerSetupRepository:
    ...
    def _lock_issue_boundary(self, business_id: str, platform: str) -> None:
        """Serialize setup replacement for one tenant/platform pair."""
    ...
    def issue(
        ...
        *,
        ...
        self._lock_issue_boundary(current.business_id, selected_platform.value)
        current = self._current_actor(actor)
        self._conn.execute(
            """
