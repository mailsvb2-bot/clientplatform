...
CLIENTPLATFORM_PRIVACY_MANIFEST_VERSION = "2026-08-21.v33-native-messenger-setup"
...
_POLICIES = (
    ...
    _required("business_admin_settings", "retain", "business-owned administrator configuration and automation settings"),
    ...
    _required("messenger_connection_setup_sessions", "erase", "short-lived owner capability for secure VK/MAX connection setup"),
