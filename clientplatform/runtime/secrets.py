...
class EnvironmentCredentialProvider:
    ...
    def __init__(
        ...
        *,
        ...
        self._allowed_name_prefix = str(allowed_name_prefix or "CLIENTPLATFORM_SECRET_").strip()
    ...
    def resolve(self, reference: str) -> str:
        ...
        if not variable_name.startswith(self._allowed_name_prefix):
            raise SecretReferenceError("secret environment reference is outside clientplatform namespace")
