...
class ClientPlatformProductionIsolationTests(unittest.TestCase):
    ...
    def test_production_templates_are_isolated_and_operational(self) -> None:
        ...
        self.assertIn("/clientplatform/managed-bots/*", caddy)
        ...
        self.assertIn("Managed Client Bots share the same application process", runbook)
        self.assertIn("POSTGRES_BOT_GATEWAY_CONCURRENCY_OK", (root / "scripts/probe_postgres_bot_gateway_concurrency.py").read_text(encoding="utf-8"))
