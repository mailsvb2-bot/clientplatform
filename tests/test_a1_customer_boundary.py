...
class A1CustomerBoundaryTests(unittest.TestCase):
    ...
    def test_a1_privacy_manifest_fails_closed_for_unknown_business_table(self) -> None:
        report = validate_a1_privacy_manifest(self.conn, strict=False)
        ...
        with self.assertRaisesRegex(RuntimeError, "a1_privacy_manifest_invalid"):
            validate_a1_privacy_manifest(self.conn, strict=True)
