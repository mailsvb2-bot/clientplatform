...
from handlers.clientplatform_admin_callback_guard import (
...
async def test_admin_callback_guard_does_not_swallow_advertising_namespace() -> None:
    guard = ClientPlatformAdminCallbackNamespace(_decode_business_token)
...
async def test_admin_callback_guard_is_installed_once_and_accepts_live_admin_token() -> None:
    ...
    install_admin_callback_namespace_guard(admin_module, control_module)
    install_admin_callback_namespace_guard(admin_module, control_module)
