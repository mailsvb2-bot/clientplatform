...
class NativeCustomerInteractionOutboxTests(unittest.TestCase):
    ...
    def test_archived_customer_is_cancelled_before_provider_boundary(self) -> None:
        ...
        self.fx.outbox.materialize_customer_interaction(
            ...
            platform="vk",
            interaction=interaction,
            interaction_key="archive-before-send",
        ...
        self.fx.customers.archive_customer(
            actor=self.fx.owner,
            customer_id=self.fx.customer.id,
        ...
        self.assertEqual(
            row["last_error"],
            "customer_interaction_recipient_revoked",
        )
