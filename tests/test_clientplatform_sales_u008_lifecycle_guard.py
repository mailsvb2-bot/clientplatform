...
class ClientPlatformSalesU008LifecycleGuardTests(unittest.TestCase):
    def test_lost_lead_must_reopen_before_won(self) -> None:
        ...
        try:
            ...
            with self.assertRaisesRegex(
                SalesInvariantViolation,
                "must be reopened before progressing",
            ):
                sales.set_stage(
                    actor=owner,
                    lead_id=lost.id,
            ...
            self.assertIs(won.stage, SalesLeadStage.WON)
