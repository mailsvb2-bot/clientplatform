...
def next_action(snapshot: PlatformResourceSnapshot) -> str:
    ...
    if highest >= 95:
        return (
            ...
            "Yandex Cloud. Если расход штатный — увеличьте дневной лимит "
            "соответствующего VISUAL_GATEWAY_* параметра; если нет — оставьте "
            "блокировку и разберитесь с источником расхода."
        )
    if highest >= 85:
        return (
